...
import com.skylin.uav.myuying.util.JsonParser;
...
public class SpeechActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    // 引擎类型
    private String mEngineType = SpeechConstant.TYPE_CLOUD;  //云端
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResultText = findViewById(R.id.mResultText);
        ...
        switch (view.getId()) {
            case R.id.iat_recognize:
                if (null == mIat) {
                    ...
                    Toast.makeText(getBaseContext(), "创建对象失败，请确认 libmsc.so 放置正确，且有调用 createUtility 进行初始化", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (isShowDialog) {
                    ...
                    mIatDialog.show();
                    Toast.makeText(getBaseContext(), "请开始说话…", Toast.LENGTH_SHORT).show();
                } else {
                    // 不显示听写对话框
    ...
    private RecognizerDialogListener mRecognizerDialogListener = new RecognizerDialogListener() {
        ...
        public void onError(SpeechError error) {
            if (mTranslateEnable && error.getErrorCode() == 14002) {
                ...
                Toast.makeText(getBaseContext(), error.getPlainDescription(true), Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onEndOfSpeech() {
            ...
            Toast.makeText(getBaseContext(), "结束说话", Toast.LENGTH_SHORT).show();
        ...
        public void onVolumeChanged(int volume, byte[] data) {
            Toast.makeText(getBaseContext(), "当前正在说话，音量大小：" + volume, Toast.LENGTH_SHORT).show();
    ...
    private void printTransResult(RecognizerResult results) {
        ...
        if (TextUtils.isEmpty(trans) || TextUtils.isEmpty(oris)) {
            Toast.makeText(getBaseContext(), "解析结果失败，请确认是否已开通翻译功能。", Toast.LENGTH_SHORT).show();
        } else {
